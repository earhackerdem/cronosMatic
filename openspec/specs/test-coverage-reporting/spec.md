# Spec: Test Coverage Reporting

## Purpose

Establish a consistent, automated coverage reporting workflow integrated directly into the pytest invocation, producing both terminal output and a browsable HTML report on every test run.
