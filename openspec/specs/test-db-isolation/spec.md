# Spec: Test DB Isolation

## Purpose

Ensure that the automated test suite runs against a dedicated isolated PostgreSQL database (`app_test_db`) so that development data is never touched or corrupted by test execution.
