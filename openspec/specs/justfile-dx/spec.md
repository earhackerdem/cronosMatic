...
Defines the developer experience automation layer via a `Justfile` at the repository root. Provides a unified set of `just` recipes for common development tasks: environment setup, testing, linting, formatting, database migrations, and container management.
